...
@section('page_title','Edit-Inactive-Vendor')
@section('container')
<div class="row">
     ...
     <div class=" alert-success" id="mydiv1">{{session('success')}}</div>
   	...
   	div class="row">
   	<h3>welcome to Inactive edit portion</h3>
				...
				<form action="{{route('inactive/update')}}" method="post">
	...
	<input type="text" name="name" value="{{$name}}" placeholder="Enter Your name" required id="menu" class="form-control form-control-sm"  >
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-9">
							...
							<option value="{{$rest_status}}">inactive</option>
