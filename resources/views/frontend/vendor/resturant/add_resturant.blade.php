		...
		<div class="row">
			...
			<form action="{{route('admin/resturant/submit')}}" method="post"  enctype="multipart/form-data" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-9">
							<input type="email" name="rest_email" value="{{$rest_email}}" placeholder="Enter Your rest_email" required id="rest_email" class="form-control form-control-sm">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-9">
							<input type="number" name="rest_phone" value="{{$rest_phone}}" placeholder="Enter Your rest_phone" required id="rest_phone" class="form-control form-control-sm">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-9">
							<select name="category_id" required id="" class="form-control form-control-sm">
								<option value="" disabled>-- Select Any One --</option>
								@foreach($result as $data )
							
							<option value="{{$data->id}}">{{$data->cats_name}}</option>
